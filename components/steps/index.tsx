    ...
    <div className="my-5">
      <div className="flex">
        ...
        <div className="pt-1 pb-8">
          <p className="text-md md:text-lg text-gray-300">Lucien Solutions</p>
          <p className="text-gray-400 italic text-xs md:text-sm font-normal">
            June 2022 - July 2022
          </p>
          <p className="text-xl font-bold mt-2 mb-1">
            React Frontend developer
          </p>
          <ul className="list-disc list-outside text-md text-gray-400 ">
            <li>
      ...
      <div className="flex">
        ...
        <div className="pt-1 pb-8">
          ...
          <ol className="list-disc list-outside text-md text-gray-400 ">
            <li>
              As a frontend developer, I refactored the purchased ReactJS
              template, removing unused code, and organizing components to
              improve maintainability, readability, and minimize potential bugs.
      ...
      <div className="flex">
        ...
        <div className="pt-1 pb-8">
          ...
          <p className="text-white">
            ...
            looks thin. Hello, little man. I will destroy you!
          </p>
        </div>
      </div>
    </div>
