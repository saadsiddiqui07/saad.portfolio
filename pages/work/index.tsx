      ...
      <main className="mt-4 mx-4">
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  p-2 gap-5">
          {videos.map((video, index) => (
            <div key={index} className="flex flex-col items-center p-1">
              ...
              <a
                target="_blank"
                href={`https://github.com/saadsiddiqui07/${video.href}`}
              >
                <small
        ...
        <div>
          <p className="my-2">
            ...
            proficiency, demonstrating my passion for delivering intuitive user
            experiences across mobile platforms. From dynamic web applications
            to immersive mobile experiences, My work exemplify my commitment to
            leveraging the latest tools and frameworks to bring ideas to life.
            Dive in and discover the seamless integration of innovation and
            craftsmanship that defines my work on my{" "}
            <a
              target="_blank"
